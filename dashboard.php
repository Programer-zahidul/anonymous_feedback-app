    ...
    <header class="bg-white">
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <span
                    class="text-sm font-semibold leading-6 text-gray-900"><?php echo $_SESSION["user_data"]["name"] ?></span>
            </div>
        </nav>
            ...
            <div class="relative max-w-7xl mx-auto">
                <div class="flex justify-end">
                    <span class="block text-gray-600 font-mono border border-gray-400 rounded-xl px-2 py-1">Your
                        feedback form link: <strong>http://localhost/anonymous-feedback-app/feedback.php</strong></span>
                </div>
                <h1 class="text-xl text-indigo-800 text-bold my-10">Received feedback</h1>
                <?php $length = count($feedback_data);
                if ($length > 1) { ?>
                        ...
                        for ($i = 0; $i < $length - 1; $i++) {
                            ...
                            <div
                                ...
                                <div class="focus:outline-none">
                                    <p class="text-gray-500"><?php echo $feedback_data[$i]; ?></p>
                                </div>
                            </div>
                        <?php }
                        ?>
                ...
                <?php } else { ?>
                    <div
                        class="relative flex items-center space-x-3 rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
                        <div class="focus:outline-none">
                            <p class="text-gray-500">(: Here, No feedback found.</p>
                        </div>
                    </div>
                    <?php
                } ?>
